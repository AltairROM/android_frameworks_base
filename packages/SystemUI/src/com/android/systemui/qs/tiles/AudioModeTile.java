 ...
 *           (C) 2021-2023 Altair ROM Project
 *
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (enabled) {
            ...
            state.dualLabelContentDescription = r.getString(
                    R.string.accessibility_quick_settings_audio_mode_changed_mono, getTileLabel());
        } else {
            state.icon = mIconAudioStereo;
            state.secondaryLabel = r.getString(R.string.quick_settings_audio_mode_stereo);
            state.dualLabelContentDescription = r.getString(
                    R.string.accessibility_quick_settings_audio_mode_changed_stereo, getTileLabel());
        }
